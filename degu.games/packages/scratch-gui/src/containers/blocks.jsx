...
Blocks.defaultOptions = {
    ...
    // Canvas grid visuals are now handled by CSS; keep Blockly grid for snapping only.
    grid: {
        spacing: 24, // aligns with the visual dotted grid
        length: 0, // no lines rendered by Blockly
        colour: "transparent", // ensure no line color bleeds through
        snap: true, // enable snapping to the 24px grid
    },
    comments: true,
    collapse: false,
    sounds: false,
