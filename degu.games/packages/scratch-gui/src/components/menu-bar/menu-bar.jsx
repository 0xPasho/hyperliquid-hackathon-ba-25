...
import ProjectSettingsModal from "../../containers/project-settings-modal.jsx";
...
import customLogo from "../../../static/logo.png";
...
const getScratchLogo = (platform) => customLogo;
...
class MenuBar extends React.Component {
    constructor(props) {
        ...
        bindAll(this, [
            ...
            "handleCloseProjectSettingsModal",
    ...
    handleClickShare(waitForUpdate) {
        if (!this.props.isShared) {
            // Open the project settings modal before publishing
    ...
    handlePublishProject(projectSettings) {
        // Close the modal
        this.setState({ projectSettingsModalOpen: false });

        // Proceed with the original share logic
    ...
    handleSetMode(mode) {
        return () => {
            ...
            if (mode === "1990") {
                ...
                document.getElementById("logo_img").src = getScratchLogo(
                    this.props.platform
                );
            }
        ...
        return (
            <Box className={classNames(this.props.className, styles.menuBar)}>
                ...
                <ProjectSettingsModal
                    ...
                    onCancel={this.handleCloseProjectSettingsModal}
                    onPublish={this.handlePublishProject}
                />
            </Box>
        );
    }
...
const mapDispatchToProps = (dispatch, ownProps) => ({
    ...
    onSeeCommunity:
        ownProps.onSeeCommunity ?? (() => dispatch(setPlayer(true))),
