...
import blockchainIconURL from './blockchain/blockchain.png';
import blockchainInsetIconURL from './blockchain/blockchain-small.svg';
...
export default [
    {
        name: (
            <FormattedMessage
                ...
                description="Name for the 'Betting' extension"
                id="gui.extension.betting.name"
            />
        ),
        extensionId: 'betting',
        iconURL: blockchainIconURL,
        insetIconURL: blockchainInsetIconURL,
        description: (
            <FormattedMessage
                defaultMessage="Create multiplayer betting games."
                description="Description for the 'Betting' extension"
                id="gui.extension.betting.description"
            />
        ),
        featured: true
    },
